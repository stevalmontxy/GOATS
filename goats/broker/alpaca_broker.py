...
from alpaca.trading.models import TradeAccounts
...
class AlpacaBroker(Broker):
    ...
    def __init__(self, api_key, secret_key, paper,):
        ...
        initialize_clients(self, api_key, secret_key, paper)
    ...
    def get_stock_data(self, symbols, timeframe, num_candles):
        ...
        if USE_FMP:
            ...
            raise NotImplementedError("using alpaca stock data client not set up yet")
    ...
    def get_options_chain(self, underlying):
        '''
        TAKING OVER FOR options_chain_req(underlying_symbol, side, expiration_date=None, min_expiration=None, max_expiration=None, min_strike=None, max_strike=None):
    ...
    def find_closest_option(self):
        '''
        taking over for find_closest_option(option: Option):
    ...
    def get_closest_open_day(self, date):
    ...
    def place_orders(self, orders):
        ...
        if type == Limit and orders.position.is_stock==False:
    ...
    def close_positions(self, symbols):
        '''works for single order or multiple orders
        TAKES OVER FOR close_position(pos: Position, order_type, receipts):
    ...
    def get_open_orders(self):
        ...
        # the return type is Order, but you can just treat it as a json

    def get_positions(self):
        positions = self.trade_client.get_all_positions()
        # return list of positions
        # the return type is Position, but you can just treat it as a json
